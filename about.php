...
<?php include('include/header.php'); ?>
  ...
  <body>
    <div class="container">
      <img class="img-fluid" src="about/slide3.jpg" alt="">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <p>The United States imports and exports LNG. Sometimes, LNG originally imported to the United States is re-exported to other destinations where prices are higher. In 2016, the United States imported about 88 billion cubic feet (Bcf) of LNG. All LNG imports were from Trinidad and Tobago (95%), Norway (4%), and Canada (1%). </p>
          <p>In 2016, the U.S. exported about 187 Bcf of LNG to 18 countries, which included about 3 Bcf of re-exported LNG. Nearly all LNG exports were by vessel (tanker ships). A small amount was exported by truck to Canada and Mexico. </p>
          <p>The top 5 destination countries and shares of total U.S. LNG exports in 2016 </p>
            <ul>Chile—16%
            </br>Mexico—15%
            </br>India—9%
            </br>Argentina—9%
            <br>China—9% </ul>
          <p>Interest in using LNG as a fuel for heavy-duty vehicles, ocean tankers, and other transportation applications is on the rise. </p>
        </div>
      </div>
    <!-- /.container -->
    <!-- Footer -->
