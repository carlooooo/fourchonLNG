...
<div class="col-sm-8">
  <table class="table">
	...
	<?php
$name = $_GET['name'];
	 $data_lists = $db->select('webcontent_process',"where webpage_name='".$name."' order by position_order asc");
...
function getvalues(){
  ...
  jQuery.ajax({
   ...
   type: "POST",
   url: "webcontent/addcontentprocess.php",
  dataType:"text",
  data:dataString,
  async:false,
