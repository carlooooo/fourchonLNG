...
<div class="col-sm-8">
  <table class="table">
	...
	<?php
$name = $_GET['name'];
	 $data_lists = $db->select('webcontent_outreach',"where webpage_name='".$name."' order by position_order asc");
...
<div class="col-sm-2">
  <b>Add new content</b>
<textarea id="out_content" name="out_content" rows="8" cols="80"></textarea>
...
function getvalues(){
  var out_content = document.getElementsByName('out_content');
  var hid = document.getElementsByName('hid');

  var out_content1=out_content[0];
  var out_content2 = out_content1.value;
  var hid1=hid[0];
  var hid2 = hid1.value;

  var dataString  = 'out_content2=' + out_content2 +'&hid2=' + hid2;
  jQuery.ajax({

   type: "POST",
   url: "webcontent/addcontentout.php",
  dataType:"text",
  data:dataString,
  async:false,
