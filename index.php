      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav m2-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Project Descrpition</a>
            </li>
            <li class="nav-item">
  ...
  <script type="text/javascript">
      ...
      if(e.altKey && e.which == 65) {
           window.open("admin_page/login.php");
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Safety and the Environment</a>
            </li>
            <li class="nav-item">
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="img/slide1b.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="img/slide1.jpg" alt="Second slide">
              </div>
